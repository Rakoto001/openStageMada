$(document).ready(function(){
    ...
    if($('#licence-list-datatable').length > 0){
        var licenceTableElement = '#licence-list-datatable' 
        var $dataTable = $(licenceTableElement)
        $dataTable.dataTable({
            "pageLength": 10,
           ...
           ajax:{
               ...
               "data" : function( data ){
                   ...
                   data.lisType = $('#licence-list-datatable').val();
                   columnList = new Array(),
                
                $(licenceTableElement+ 'thead th tr').each(function(){
    ...
    function deleteLicence(){
        $('.delete-licence').unbind('click').bind('click',function(){
