$(document).ready(function(){
    ...
    if($('#annonce-list-datatable').length > 0){
        var tableElement = '#annonce-list-datatable';
        ...
        $table.dataTable({
            ...
            ajax: {
                ...
                "data": function ( data ) {
                    ...
                    data.listType = $("#annonce-list-datatable").val() ;
    ...
    function deleteAnnonce(){
        $('.delete-annonce').unbind('click').bind('click',function(){
