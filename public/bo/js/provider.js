$(document).ready(function(){
    ...
    if($('#provider-list-datatable').length > 0){
        var tableElement = '#provider-list-datatable';
        ...
        $table.dataTable({
            ...
            ajax: {
                ...
                "data": function ( data ) {
                    ...
                    data.provider = $table.attr('provider');
                    data.listType = $("#provider-list-datatable").val() ;
    ...
    function deleteProvider(){
        $('.delete-provider').unbind('click').bind('click',function(){
